...
RUN curl -L --silent ${DOWNLOAD_URL_MYSQL_CONNECTOR} | tar -xz --strip=1 -C "${BITBUCKET_INSTALL_DIR}/lib" mysql-connector-java-${MYSQL_CONNECTOR_VERSION}/mysql-connector-java-${MYSQL_CONNECTOR_VERSION}-bin.jar